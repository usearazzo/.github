...
| [**Validator**](https://github.com/usearazzo/arazzo-toolkit) | `@usearazzo/validator` — the same validation the CLI runs, as a library: every violation against the Arazzo specification, with the location that caused it. |
